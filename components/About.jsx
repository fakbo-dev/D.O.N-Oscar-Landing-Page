            ...
            <section className="mt-[80px] xl:mt-[200px] relative z-20">
                ...
                <div className="container mx-auto  xl:px-0">
                    ...
                    <div className="flex flex-col text-center xl:flex-row  xl:text-left justify-between items-center gap-8 xl:gap-[74px]">
                        {/* Text */}
                        <RevealWrapper origin="left" interval={100} delay={800} distance="60px" duration={3000} reset="true" >
                        ...
                        {/* img */}
                        <RevealWrapper origin="right" interval={100} delay={800} distance="60px" duration={3000} reset="true" className="max-w-[453px] order-1 xl:order-none mx-auto xl:mx-8 xl:max-w-none">
                            <Image src={sideImage}
